...
| `GET` | `/profile/{username}/comments` | Core | [Get Comments](/restapi/operations/comments/get-comments) | `ProfileController@getComments` |
| `GET` | `/comments/{id}` | Core | [Get Comment](/restapi/operations/comments/get-comment) | `CommentsController@show` |
| `GET` | `/admin/courses/{course_id}/comments` | Core | [Get Course Comments](/restapi/operations/comments/get-course-comments) | `CourseAdminController@getCourseComments` |
