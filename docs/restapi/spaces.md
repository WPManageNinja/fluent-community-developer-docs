...
| `GET` | `/spaces/{spaceSlug}/primary-menu` | Core | [Get Primary Menu](/restapi/operations/spaces/get-primary-menu) | Get Primary Menu for the FluentCommunity Spaces API. |
| `POST` | `/spaces/{spaceSlug}/primary-menu` | Core | [Post Update Primary Menu](/restapi/operations/spaces/post-update-primary-menu) | Post Update Primary Menu for the FluentCommunity Spaces API. |
