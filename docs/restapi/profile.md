...
| `POST` | `/profile/{username}/reconfirm-email` | Core | [Post Reconfirm Email](/restapi/operations/profile/post-reconfirm-email) | Post Reconfirm Email for the FluentCommunity Profile API. |
