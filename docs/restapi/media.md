...
| `DELETE` | `/feeds/{feed_id}/media-preview` | Core | [Delete Media Preview](/restapi/operations/media/delete-media-preview) | `FeedsController@deleteMediaPreview` |
...
| `POST` | `/fluent-player/audio-media/{media_id}` | Core | [Post Update Audio Meta](/restapi/operations/media/post-update-audio-meta) | `MediaController@updateAudioMeta` |
| `GET` | `/media-gallery/{spaceSlug}` | <span class="pro-badge">PRO</span> | [Get Index](/restapi/operations/media/get-index) | `MediaGalleryController@index` |
