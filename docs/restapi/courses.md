...
| `GET` | `/admin/courses/{course_id}/export/quiz-results` | <span class="pro-badge">PRO</span> | [Get Get Exportable Quiz Results](/restapi/operations/courses/get-get-exportable-quiz-results) | `FluentCommunityPro\App\Modules\Quiz\Http\Controllers\QuizController@getExportableQuizResults` |
