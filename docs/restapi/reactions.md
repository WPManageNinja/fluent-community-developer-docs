...
| `POST` | `/feeds/{feed_id}/reactions/toggle` | Core | [Post Add Or Remove Post React](/restapi/operations/reactions/post-add-or-remove-post-react) | `ReactionController@addOrRemovePostReact` |
