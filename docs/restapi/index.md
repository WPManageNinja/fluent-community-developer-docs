...
This reference covers 243 routes registered in the FluentCommunity core and module route files.
...
| [Courses API](/restapi/courses) | Core + <span class="pro-badge">PRO</span> | 50 | Portal course consumption endpoints and the full course administration surface. |
