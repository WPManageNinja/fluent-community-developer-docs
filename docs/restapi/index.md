...
This reference covers 261 routes registered in the FluentCommunity core and module route files.
...
| [Spaces API](/restapi/spaces) | Core <span class="edition-note">(extended by Pro)</span> | 32 | Space discovery, lifecycle management, joins/leaves, lock screen configuration, and group organization. |
