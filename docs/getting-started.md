...
- **Hooks:** 163 unique action hooks and 261 unique filter hooks found across 557 call sites in the core and Pro `app/` and `Modules/` trees.
- **REST API:** 245 registered routes across core and Pro route files.
