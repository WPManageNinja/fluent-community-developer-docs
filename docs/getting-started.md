...
- **Hooks:** 164 unique action hooks and 272 unique filter hooks found across 570 call sites in the core and Pro `app/` and `Modules/` trees.
- **REST API:** 248 registered routes across core and Pro route files.
