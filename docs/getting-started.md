...
- **Hooks:** 160 unique action hooks and 254 unique filter hooks found across 545 call sites in the core and Pro `app/` and `Modules/` trees.
- **REST API:** 243 registered routes across core and Pro route files.
