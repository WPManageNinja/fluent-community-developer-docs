...
- **Hooks:** 162 unique action hooks and 256 unique filter hooks found across 549 call sites in the core and Pro `app/` and `Modules/` trees.
- **REST API:** 244 registered routes across core and Pro route files.
