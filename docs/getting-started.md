...
- **Hooks:** 154 unique action hooks and 237 unique filter hooks found across 521 call sites in the core and Pro `app/` and `Modules/` trees.
- **REST API:** 236 registered routes across core and Pro route files.
