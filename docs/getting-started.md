...
- **Hooks:** 186 unique action hooks and 291 unique filter hooks found across 629 call sites in the core and Pro `app/` and `Modules/` trees.
- **REST API:** 249 registered routes across core and Pro route files.
