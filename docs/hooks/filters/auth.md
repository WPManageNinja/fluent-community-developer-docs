...
| [`fluent_community/auth/after_login_with_invitation`](#fluent_communityauthafter_login_with_invitation) | Core | 1 | `fluent-community/Modules/Auth/AuthModdule.php:614` |
| [`fluent_community/auth/after_signup_redirect_url`](#fluent_communityauthafter_signup_redirect_url) | Core | 1 | `fluent-community/Modules/Auth/AuthModdule.php:528` |
...
| [`fluent_community/auth/login_url`](#fluent_communityauthlogin_url) | Core | 1 | `fluent-community/app/Hooks/Handlers/PortalHandler.php:1234` |
...
| [`fluent_community/auth/pre_content`](#fluent_communityauthpre_content) | Core | 1 | `fluent-community/Modules/Auth/AuthModdule.php:228` |
...
| Core | `fluent-community/Modules/Auth/AuthModdule.php:629` | `$redirectUrl` (mixed)<br>`$user` (mixed) |
...
| Edition | Source | Parameters |
| --- | --- | --- |
| Core | `fluent-community/Modules/Auth/AuthModdule.php:614` | `null` (mixed)<br>`$user` (mixed)<br>`$invitationToken` (mixed) |
...
| Edition | Source | Parameters |
| --- | --- | --- |
| Core | `fluent-community/Modules/Auth/AuthModdule.php:528` | `$redirectUrl` (mixed)<br>`$user` (mixed)<br>`$_REQUEST` (array) |
...
| Edition | Source | Parameters |
| --- | --- | --- |
| Core | `fluent-community/app/Hooks/Handlers/PortalHandler.php:1234` | `Helper::getAuthUrl()` (mixed) |
...
| Edition | Source | Parameters |
| --- | --- | --- |
| Core | `fluent-community/Modules/Auth/AuthModdule.php:228` | `''` (mixed)<br>`$context` (mixed)<br>`$targetForm` (mixed)<br>`$frameData` (mixed) |
