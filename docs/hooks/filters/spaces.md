...
| Edition | Source | Parameters |
| --- | --- | --- |
| Core | `fluent-community/app/Services/LockscreenService.php:130` | `$formattedField` (mixed)<br>`$value` (mixed)<br>`$space` (Space) |
...
| Edition | Source | Parameters |
| --- | --- | --- |
| Core | `fluent-community/app/Services/Helper.php:1347` | `$menuGroups` (mixed) |
...
| Edition | Source | Parameters |
| --- | --- | --- |
| Core | `fluent-community/app/Functions/Utility.php:1278` | `[]` (array)<br>`$userModel` (mixed) |
...
| Edition | Source | Parameters |
| --- | --- | --- |
| <span class="pro-badge">PRO</span> | `fluent-community-pro/app/Http/Controllers/ProAdminController.php:468` | `$formattedFields` (mixed)<br>`$course` (Course) |
| <span class="pro-badge">PRO</span> | `fluent-community-pro/app/Http/Controllers/ProAdminController.php:493` | `$formattedFields` (mixed)<br>`$space` (Space) |
