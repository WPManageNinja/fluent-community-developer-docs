...
| [`fluent_community/general_portal_vars`](#fluent_communitygeneral_portal_vars) | Core | 1 | `fluent-community/app/Hooks/Handlers/PortalHandler.php:754` |
...
| [`fluent_community/main_menu_items`](#fluent_communitymain_menu_items) | Core | 2 | `fluent-community/app/Functions/Utility.php:1176` |
...
| [`fluent_community/portal_data_vars`](#fluent_communityportal_data_vars) | Core | 1 | `fluent-community/app/Hooks/Handlers/PortalHandler.php:995` |
...
| [`fluent_community/portal_supported_query_params`](#fluent_communityportal_supported_query_params) | Core | 1 | `fluent-community/app/Services/Helper.php:2006` |
...
| [`fluent_community/profile_spaces_api_response`](#fluent_communityprofile_spaces_api_response) | Core | 1 | `fluent-community/app/Http/Controllers/ProfileController.php:473` |
| [`fluent_community/settings_menu`](#fluent_communitysettings_menu) | Core | 1 | `fluent-community/app/Functions/Utility.php:1171` |
| [`fluent_community/sidebar_menu_groups_config`](#fluent_communitysidebar_menu_groups_config) | Core | 1 | `fluent-community/app/Functions/Utility.php:1178` |
...
| [`fluent_community/space_header_links`](#fluent_communityspace_header_links) | Core | 1 | `fluent-community/app/Models/BaseSpace.php:625` |
...
| Edition | Source | Parameters |
| --- | --- | --- |
| Core | `fluent-community/app/Hooks/Handlers/PortalHandler.php:754` | `[ 'scope' => $scope, 'theme' => get_option('template'), 'default_color' => 'light', 'color_switch_cookie_name' => '', 'has_color_scheme' => Helper::hasColorScheme(), 'collapse_sidebar_groups' => Utility::isCustomizationEnabled('collapse_sidebar_groups'), ]` (array) |
...
| Edition | Source | Parameters |
| --- | --- | --- |
| Core | `fluent-community/app/Functions/Utility.php:1176` | `$primaryMenuItems` (mixed)<br>`$scope` (mixed) |
| Core | `fluent-community/app/Hooks/Handlers/PortalHandler.php:1153` | `$items` (mixed)<br>`$scope` (mixed) |
...
| Edition | Source | Parameters |
| --- | --- | --- |
| Core | `fluent-community/app/Http/Controllers/SettingController.php:96` | `$data` (mixed)<br>`$request->all()` (array) |
...
| Edition | Source | Parameters |
| --- | --- | --- |
| Core | `fluent-community/app/Hooks/Handlers/PortalHandler.php:995` | `$dataVars` (mixed) |
...
| Edition | Source | Parameters |
| --- | --- | --- |
| Core | `fluent-community/app/Services/Helper.php:2006` | `[ 'customizer_panel', 'create_space' ]` (array) |
...
| Edition | Source | Parameters |
| --- | --- | --- |
| Core | `fluent-community/app/Http/Controllers/ProfileController.php:473` | `$data` (mixed)<br>`$request->all()` (array) |
...
| Edition | Source | Parameters |
| --- | --- | --- |
| Core | `fluent-community/app/Functions/Utility.php:1171` | `[]` (array)<br>`$userModel` (mixed) |
...
| Edition | Source | Parameters |
| --- | --- | --- |
| Core | `fluent-community/app/Functions/Utility.php:1178` | `[ 'primaryItems' => $primaryMenuItems, 'spaceGroups' => $spaceGroups, 'settingsItems' => $settingsMenu, 'topInlineLinks' => $topInlines, 'bottomLinkGroups' => $bottomLinkGroups, 'is_admin' => Helper::isSiteAdmin(null, $userModel), 'has_color_scheme' => Helper::hasColorScheme(), 'context' => $scope, ]` (array)<br>`$userModel` (mixed) |
...
| Edition | Source | Parameters |
| --- | --- | --- |
| Core | `fluent-community/app/Models/BaseSpace.php:625` | `$headerLinks` (mixed)<br>`$this` (mixed) |
