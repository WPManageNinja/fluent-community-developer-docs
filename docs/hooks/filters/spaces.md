...
| Edition | Source | Parameters |
| --- | --- | --- |
| Core | `fluent-community/app/Hooks/Handlers/PortalHandler.php:755` | `[ 'scope' => $scope, 'theme' => get_option('template'), 'default_color' => 'light', 'color_switch_cookie_name' => '', 'has_color_scheme' => Helper::hasColorScheme(), 'collapse_sidebar_groups' => Utility::isCustomizationEnabled('collapse_sidebar_groups'), 'hide_header_on_scroll' => Utility::isCustomizationEnabled('hide_header_on_scroll'), ]` (array) |
