...
| [`fluent_community/media_upload_data`](#fluent_communitymedia_upload_data) | Core + <span class="pro-badge">PRO</span> | 4 | `fluent-community-pro/app/Modules/DocumentLibrary/Http/DocumentController.php:262` |
| [`fluent_community/media_upload_max_file_size`](#fluent_communitymedia_upload_max_file_size) | Core | 2 | `fluent-community/app/Http/Controllers/FeedsController.php:899` |
| [`fluent_community/media_upload_max_file_unit`](#fluent_communitymedia_upload_max_file_unit) | Core | 2 | `fluent-community/app/Http/Controllers/FeedsController.php:898` |
| [`fluent_community/media_upload_max_width_{context}`](#fluent_communitymedia_upload_max_width_context) | Core | 2 | `fluent-community/app/Http/Controllers/FeedsController.php:946` |
| [`fluent_community/media_upload_resize`](#fluent_communitymedia_upload_resize) | Core | 2 | `fluent-community/app/Http/Controllers/FeedsController.php:943` |
...
| Core | `fluent-community/app/Http/Controllers/FeedsController.php:1039` | `$mediaData` (mixed)<br>`$file` (mixed) |
...
| Edition | Source | Parameters |
| --- | --- | --- |
| Core | `fluent-community/app/Http/Controllers/FeedsController.php:899` | `100` (mixed) |
...
| Edition | Source | Parameters |
| --- | --- | --- |
| Core | `fluent-community/app/Http/Controllers/FeedsController.php:898` | `'MB'` (mixed) |
...
| Edition | Source | Parameters |
| --- | --- | --- |
| Core | `fluent-community/app/Http/Controllers/FeedsController.php:946` | `$maxWidth` (mixed)<br>`$file` (mixed) |
...
| Edition | Source | Parameters |
| --- | --- | --- |
| Core | `fluent-community/app/Http/Controllers/FeedsController.php:943` | `$willResize` (mixed)<br>`$file` (mixed) |
