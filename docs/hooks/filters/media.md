...
| [`fluent_community/media_upload_max_file_size`](#fluent_communitymedia_upload_max_file_size) | Core | 2 | `fluent-community/app/Http/Controllers/FeedsController.php:978` |
| [`fluent_community/media_upload_max_file_unit`](#fluent_communitymedia_upload_max_file_unit) | Core | 2 | `fluent-community/app/Http/Controllers/FeedsController.php:977` |
| [`fluent_community/media_upload_max_width_{context}`](#fluent_communitymedia_upload_max_width_context) | Core | 2 | `fluent-community/app/Http/Controllers/FeedsController.php:1025` |
| [`fluent_community/media_upload_resize`](#fluent_communitymedia_upload_resize) | Core | 2 | `fluent-community/app/Http/Controllers/FeedsController.php:1022` |
...
| Core | `fluent-community/app/Http/Controllers/FeedsController.php:1118` | `$mediaData` (mixed)<br>`$file` (mixed) |
...
| Edition | Source | Parameters |
| --- | --- | --- |
| Core | `fluent-community/app/Http/Controllers/FeedsController.php:978` | `100` (mixed) |
...
| Edition | Source | Parameters |
| --- | --- | --- |
| Core | `fluent-community/app/Http/Controllers/FeedsController.php:977` | `'MB'` (mixed) |
...
| Edition | Source | Parameters |
| --- | --- | --- |
| Core | `fluent-community/app/Http/Controllers/FeedsController.php:1025` | `$maxWidth` (mixed)<br>`$file` (mixed) |
...
| Edition | Source | Parameters |
| --- | --- | --- |
| Core | `fluent-community/app/Http/Controllers/FeedsController.php:1022` | `$willResize` (mixed)<br>`$file` (mixed) |
