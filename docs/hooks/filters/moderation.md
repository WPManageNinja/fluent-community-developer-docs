...
| --- | --- | --- | --- |
| [`fluent_community/report_reasons`](#fluent-community-report-reasons) | Core | 1 | `fluent-community/app/Services/Helper.php:2225` |
...
| --- | --- | --- |
| Core | `fluent-community/app/Services/Helper.php:2225` | `array (6 keys: harassment, spam, offensive, …)` (array) |
