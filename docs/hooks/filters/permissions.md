...
| --- | --- | --- | --- |
| [`fluent_community/super_admin_capability`](#fluent_communitysuper_admin_capability) | Core | 1 | `fluent-community/app/Services/Helper.php:156` |
...
| --- | --- | --- |
| Core | `fluent-community/app/Services/Helper.php:156` | `'manage_options'` (mixed) |
