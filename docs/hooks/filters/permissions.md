...
| --- | --- | --- | --- |
| [`fluent_community/super_admin_capability`](#fluent_communitysuper_admin_capability) | Core | 1 | `fluent-community/app/Services/Helper.php:229` |
...
| --- | --- | --- |
| Core | `fluent-community/app/Services/Helper.php:229` | `'manage_options'` (mixed) |
