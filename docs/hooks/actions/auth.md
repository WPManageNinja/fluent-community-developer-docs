...
| --- | --- | --- | --- |
| [`fluent_community/auth/before_auth_page_process`](#fluent_communityauthbefore_auth_page_process) | Core | 1 | `fluent-community/Modules/Auth/AuthModdule.php:127` |
...
| --- | --- | --- |
| Core | `fluent-community/Modules/Auth/AuthModdule.php:127` | `$currentUserId` (mixed)<br>`$inviation` (mixed) |
