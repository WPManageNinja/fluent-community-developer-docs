...
| [`fluent_community/before_auth_form_header`](#fluent_communitybefore_auth_form_header) | Core | 3 | `fluent-community/app/Views/auth/login_form.php:10` |
...
| Edition | Source | Parameters |
| --- | --- | --- |
| Core | `fluent-community/app/Views/auth/login_form.php:10` | `'login'` (mixed) |
| Core | `fluent-community/app/Views/auth/user_invitation.php:11` | `'signup'` (mixed) |
| Core | `fluent-community/Modules/Auth/AuthModdule.php:726` | `'login'` (mixed) |
