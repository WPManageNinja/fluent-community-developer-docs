...
| --- | --- | --- | --- |
| [`fluent_community/feed/cast_survey_vote`](#fluent-community-feed-cast-survey-vote) | Core | 1 | `fluent-community/app/Services/FeedsHelper.php:483` |
...
| --- | --- | --- |
| Core | `fluent-community/app/Services/FeedsHelper.php:483` | `$newSyncIndexes` (mixed)<br>`$feed` (Feed)<br>`$userId` (int) |
