...
| --- | --- | --- | --- |
| [`fluent_community/section/reactions_count_updated`](#fluent_communitysectionreactions_count_updated) | Core | 1 | `fluent-community/Modules/Course/Http/Controllers/CourseAdminController.php:836` |
...
| --- | --- | --- |
| Core | `fluent-community/Modules/Course/Http/Controllers/CourseAdminController.php:836` | `$course` (mixed)<br>`$topic` (mixed) |
