...
| <span class="pro-badge">PRO</span> | `fluent-community-pro/app/Http/Controllers/ModerationController.php:170` | `$report` (mixed)<br>`$content` (mixed)<br>`$data['content_type']` (array) |
