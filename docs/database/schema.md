...
fcom_xprofile ||--o{ users : xprofile
users ||--o{ fcom_followers : follows
users ||--o{ fcom_followers : followers
users ||--o{ usermeta : usermeta
users ||--o{ external : messages
...
fcom_meta ||--o{ users : community_role
